  ...
  <div class="gap-3 py-4 px-2">
    <!-- <ul class="contact px-7 py-4 text-[16px] leading-10 w-[30vw] border">
        ...
        <li class="flex justify-start items-center">
          <p class="font-semibold w-[8vw]">Tel:</p>
          <p class="w-[14vw]">+49 151 1515115</p>
        </li>
        <li class="flex justify-start items-center">
          <p class="font-semibold w-[8vw]">E-Mail:</p>
          <p class="w-[14vw]">barberamania@gmail.com</p>
        </li>
      </ul> -->

    <div class="h-[80vh]">
      <iframe
        src="https://maps.app.goo.gl/7FLqpxpo6J7jssb47"
        style="border: 0"
        aria-hidden="true"
        tabindex="0"
        class="border map"
